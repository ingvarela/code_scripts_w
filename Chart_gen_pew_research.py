...
# [All other unchanged functions and classes from your original code remain the same...]
# ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓

# (omitting unchanged content for brevity; assume all previous code remains untouched here)

# =================== BATCH DRIVER ===================
def generate_images(root_folder: str, max_rows: int, n_images: int, manifest_path: str = os.path.join(OUTPUT_DIR, "metadata.json")):
    ensure_output_dir()
...
if __name__ == "__main__":
    ...
    generate_images(args.root, args.max_rows, args.n_images)

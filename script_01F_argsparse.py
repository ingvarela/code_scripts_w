...
parser = argparse.ArgumentParser(
    description="Synthetic OCR dataset generator with varied text/canvas/background effects."
)
parser.add_argument("--image_folder", type=str,
    default="C:/Users/svs26/Desktop/MS COCO 2017/Synthdog_en/img",
    help="Folder with background images (JPGs).")
parser.add_argument("--text_folder", type=str,
    default="C:/Users/svs26/Desktop/MS COCO 2017/Synthdog_en/gutenberg_dataset/texts",
    help="Folder with Gutenberg text files (organized in subfolders).")
parser.add_argument("--font_dir", type=str,
    default="C:/Users/svs26/Desktop/MS COCO 2017/Synthdog_en/fonts",
    help="Folder with .ttf font files.")
parser.add_argument("--output_folder", type=str,
    default="C:/Users/svs26/Desktop/MS COCO 2017/Synthdog_en/new_set_40000",
    help="Folder to save generated images.")
parser.add_argument("--metadata_folder", type=str,
    default="C:/Users/svs26/Desktop/MS COCO 2017/Synthdog_en/output16/metadata",
    help="Folder to save per-sample JSON metadata.")
parser.add_argument("--num_samples", type=int, default=300,
    help="Total number of samples to generate (including any already existing).")
...
# Low-res “sticker” effect (text canvas only)
LOWRES_P = 0.5
...
# Low-res degradation (text canvas only)
...
while produced < additional_needed:
    ...
    for attempt in range(MAX_ATTEMPTS_PER_SAMPLE):
        ...
        # low-res degradation on rotated text canvas (50/50)
        rotated_canvas, lowres_meta = degrade_canvas_quality(
            rotated_canvas, rng,
            p=LOWRES_P,
            scale_range=LOWRES_SCALE_RANGE,
            jpeg_p=LOWRES_JPEG_P,
